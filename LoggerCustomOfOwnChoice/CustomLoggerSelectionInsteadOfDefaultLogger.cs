...
namespace WCF_POCs.LoggerCustomOfOwnChoice
{
    /// <summary>
    ...
    /// </summary>
    public static class LoggerCustomSelectionInsteadOfDefaultLogger
    {
        public static void Initialize()
        {
            try
            {
                ...
                WcfLoggerFactory.SetLogger(new LoggerCustom());
    ...
    /// <summary>
    /// USER-specific custom implementation of WCF logging interfaces
    /// This bridges the generic WCF logging extension with USER's logging infrastructure
    /// </summary>
    internal class LoggerCustom : IWcfLogger
    {
